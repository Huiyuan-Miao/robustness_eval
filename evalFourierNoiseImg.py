# test the model's ability to images with fourier noise
import os
import sys
import random
import time
...
def main(whichModel,num_classes,dataDir):
    ...
    #### Parameters ####################################################################################################
    model_path = '/home/tonglab/Miao/pycharm/BlurToClearTraining/'
    ...
    #### Train/Val #####################################################################################################
    for ssnr in [1,0.95,0.9,0.85, 0.8 , 0.75, 0.7 , 0.65, 0.6 , 0.55, 0.5 , 0.45, 0.4 , 0.35, 0.3 , 0.25, 0.2 , 0.15, 0.1 , 0.05,0]:#[1.  , 0.95, 0.9 , ]
        print(ssnr)
        stat_file = open(os.path.join(model_path, whichModel, 'evalFourierNoiseImg.txt'), 'a+')
        stat_file2 = os.path.join(model_path, whichModel, 'evalFourierNoiseImgOutput_SSNR_'+str(int(ssnr*100)) + '.mat')

        val(val_loader, model, loss_function, optimizer, stat_file,stat_file2, gpu_ids,ssnr)
        stat_file.close()
...
def val(val_loader, model, loss_function, optimizer, stat_file,stat_file2, gpu_ids,ssnr):
    ...
    for batch_index, (inputs, targets, paths, indices) in enumerate(val_loader):
        inputs = add_fourier_noise(inputs,ssnr)
        if len(gpu_ids) >= 1:
            inputs = inputs.cuda(non_blocking=True)
            targets = targets.cuda(non_blocking=True)
        ...
        stat_str = 'SSNR ({:.4f}) Loss ({:.4f}) Accuracy1 ({:.4f}) Accuracy5 ({:.4f})'.\
            format(ssnr, loss_sum / (batch_index + 1), num_correct1 / batch_size_sum, num_correct5 / batch_size_sum)
...
def add_fourier_noise(images,ssnr):
    ...
    for i in range(images.size(0)):
        ...
        image_fft_shuffled = np.multiply(image_fft_mag,np.exp(1j*image_fft_phase))
...
if __name__ == '__main__':
    ...
    for i in [14]:
        if i == 1:
            whichModel = 'AlexNet_blurToClear_ImageNet/'
            num_classes = 1000
            ...
            whichModel = 'AlexNet_clear_ImageNet/'
            num_classes = 1000
            dataDir = '/home/tonglab/Datasets/imagenet1000/'
            main(whichModel=whichModel, num_classes=num_classes, dataDir=dataDir)
        elif i == 4:
            whichModel = 'AlexNet_blurToClear_ImageNet_16cate/'
            num_classes = 16
            dataDir = '/home/tonglab/Datasets/imagenet16/'
            main(whichModel=whichModel, num_classes=num_classes, dataDir=dataDir)
        elif i == 5:
            whichModel = 'AlexNet_clear_Place365_16cate/'
            num_classes = 16
            dataDir = '/home/tonglab/Datasets/places365_standard_16/'
            main(whichModel=whichModel, num_classes=num_classes, dataDir=dataDir)
        elif i == 6:
            whichModel = 'AlexNet_blurToClear_Place365_16cate/'
            num_classes = 16
            dataDir = '/home/tonglab/Datasets/places365_standard_16/'
            main(whichModel=whichModel, num_classes=num_classes, dataDir=dataDir)
        elif i == 7:
            whichModel = 'AlexNet_grayToColor_ImageNet/'
            num_classes = 1000
            dataDir = '/home/tonglab/Datasets/imagenet1000/'
            main(whichModel = whichModel,num_classes = num_classes,dataDir = dataDir)
        elif i == 8:
            whichModel = 'AlexNet_grayToColor_blurToClear_ImageNet_16cate/'
            num_classes = 16
            dataDir = '/home/tonglab/Datasets/imagenet16/'
            main(whichModel = whichModel,num_classes = num_classes,dataDir = dataDir)
        elif i == 9:
            whichModel = 'AlexNet_grayToColor_Place365_16cate/'
            num_classes = 16
            dataDir = '/home/tonglab/Datasets/places365_standard_16/'
            main(whichModel = whichModel,num_classes = num_classes,dataDir = dataDir)
        elif i == 10:
            whichModel = 'AlexNet_grayToColor_blurToClear_Place365_16cate/'
            num_classes = 16
            dataDir = '/home/tonglab/Datasets/places365_standard_16/'
            main(whichModel = whichModel,num_classes = num_classes,dataDir = dataDir)
        elif i == 11:
            whichModel = 'AlexNet_clear_colorjitter_ImageNet_16cate/'
            num_classes = 16
            dataDir = '/home/tonglab/Datasets/imagenet16/'
            main(whichModel = whichModel,num_classes = num_classes,dataDir = dataDir)
        elif i == 12:
            whichModel = 'AlexNet_noiseBlurMixedTrain_blurToClear_ImageNet_16cate/'
            num_classes = 16
            dataDir = '/home/tonglab/Datasets/imagenet16/'
            main(whichModel = whichModel,num_classes = num_classes,dataDir = dataDir)
        elif i == 13:
            whichModel = 'AlexNet_noiseBlurMixedTrain_ImageNet/'
            num_classes = 1000
            dataDir = '/home/tonglab/Datasets/imagenet1000/'
            main(whichModel = whichModel,num_classes = num_classes,dataDir = dataDir)
        elif i == 14:
            whichModel = 'AlexNet_noiseTrain_ImageNet/'
            num_classes = 1000
            dataDir = '/home/tonglab/Datasets/imagenet1000/'
            main(whichModel=whichModel, num_classes=num_classes, dataDir=dataDir)
        elif i == 15:
            whichModel = 'AlexNet_blurTrain_ImageNet/'
            num_classes = 1000
            dataDir = '/home/tonglab/Datasets/imagenet1000/'
            main(whichModel=whichModel, num_classes=num_classes, dataDir=dataDir)
